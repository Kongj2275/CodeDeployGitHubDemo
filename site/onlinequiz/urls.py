...
urlpatterns = [
    ...
    path('buttons', LoginView.as_view(template_name='quiz/buttons.html'),name='buttons'),
    ...
    path('delete-shortquestion/<int:pk>', views.delete_shortquestion_view,name='delete-shortquestion'),
